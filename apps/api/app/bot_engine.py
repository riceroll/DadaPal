            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "reply_hint 必须提供一句轻松微信语气中文回复，长度20-60字。对于 freeform_followup 阶段，把它当作「找个搭子」的持续引导："
                        "先接住用户已经说出的活动、时间、地点或期待，再根据缺失信息自然追问最多一个最有助于匹配的细节；"
                        "若信息已经足够，则总结匹配条件并说明下一步会按这些条件筛选。不要只说“我帮你留意”。"
